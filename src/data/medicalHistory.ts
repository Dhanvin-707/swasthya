...
export const imagingReports: ImagingReport[] = [
  {
    ...
    finding:
      "Clear lung fields bilaterally. Costophrenic angles sharp. No bony lesion detected.",
    impression:
  ...
  },
  {
    ...
    finding:
      "No focal lesion or midline shift. Gray-white matter differentiation preserved.",
    impression:

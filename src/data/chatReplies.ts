...
export const chatPrompts: ChatPrompt[] = [
  {
    ...
    detail:
      "Checks Hemoglobin, RBC, WBC, and Platelet levels for Anemia and infections.",
  },
  {
    id: "prompt-fever",
    ...
    detail:
      "Seasonal Dengue & Viral Fever precautions: rest, fluids, paracetamol only as advised, and urgent care if bleeding or severe abdominal pain.",
  },
  {
    id: "prompt-fbs",
    ...
    detail:
      "Monitors Blood Glucose and 3-month Average Sugar control for Diabetes.",
  },
  {
    id: "prompt-dengue",
